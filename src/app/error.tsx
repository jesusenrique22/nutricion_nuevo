...
export default function AppError({
  ...
  return (
    <div className="flex min-h-[70svh] flex-col items-center justify-center bg-background px-6 py-16 text-center">
      ...
      <p className="mt-3 max-w-md text-sm text-foreground/70 sm:text-base">
        La página no se pudo completar. Reintentá o volvé al inicio.
      </p>
