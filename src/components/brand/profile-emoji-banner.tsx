export function ProfileEmojiBanner({
  ...
  return (
    <section className="relative w-full overflow-hidden rounded-3xl border border-primary/10 bg-gradient-to-br from-primary via-primary to-[#5a1728] p-6 text-primary-foreground shadow-xl shadow-primary/20 sm:p-8">
      <div
        aria-hidden
