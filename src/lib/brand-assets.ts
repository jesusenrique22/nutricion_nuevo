...
export const BRAND_PORTADAS = {
  dark: "/brand/portadas/dark.jpg",
  cream: "/brand/portadas/cream.png",
  pink: "/brand/portadas/pink.png",
} as const;
...
export const BRAND_PRESENTATION = {
  recipeSuccess: "/brand/presentation/recipe-success.png",
  servicesPricing: "/brand/presentation/services-pricing.png",
  weeklyPlan: "/brand/presentation/weekly-plan.png",
} as const;
